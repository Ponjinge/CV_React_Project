import "./chunk-5STSMEM3.js";
import {
  useTheme
} from "./chunk-GK54VZA7.js";
import {
...
function createWithStyles(params) {
  ...
  function withStyles2(Component, cssObjectByRuleNameOrGetCssObjectByRuleName, params2) {
    ...
    const Out = (0, import_react5.forwardRef)(function(props, ref) {
      ...
      return import_react5.default.createElement(Component_, Object.assign({ ref, className: getHasNonRootClasses(classes) ? className : cx(classes.root, className) }, typeof Component === "string" ? {} : { classes }, rest));
    });
    if (name !== void 0) {
